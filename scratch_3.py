# ACTUALIZACION DEL scratch_2.py
# (21:22 July 4th, 2021) TODO print this -Isolated Margin- using pandas.
...
for i in range(len(pair_list)):
    ...
    or float(qote_asset_asset["totalAsset"])) != 0:
        ...
        pairs[pair_list[i]] = [base_asset_asset["asset"],  #ADA
                               ...
                               # second list:
                               # (total, & price)
                               # TODO 'hidden' in Class info!
                               #  (totalAssets, free-borrowed-locked,
                               #  and make calculus with how much can
